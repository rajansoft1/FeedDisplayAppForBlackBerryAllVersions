...
public class MyField4 extends Field
{
	    ...
	    public MyField4(int index,String _type,String title,String desc,String imageUrl,String reldate) 
	    {
	    ...
	    {       
	        ...
	        graphics.drawText(_rdate,77 , rpos);
	        rpos+=22;
	        if(vctr2.size()>=3)
	        {
	        for(int i=0;i<3;i++)
